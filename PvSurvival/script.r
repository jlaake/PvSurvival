...
pv.ddl=make.design.data(pv.proc,parameters=list(Phi=list(age.bins=c(0,1,2,4,6,10,50)),p=list(age.bins=c(1,2,5,50))),right=FALSE)
pv.ddl$p$adult=0
...
results=mark.wrapper(cml,data=pv.proc,ddl=pv.ddl,output=FALSE)
