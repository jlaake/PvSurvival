library(PvSurvival)
library(RMark)
pv=extract.pv(dir="C:\\Users\\JLaake\\Desktop\\Calcurr\\Master")
...
pv.ddl$Phi$timebin=cut(pv.ddl$Phi$Time,c(0,2,3:(2011-1993)),right=FALSE,labels=c("1993-1994",as.character(1995:2010)))
...
Phi.2=list(formula=~Sex+ageclass+Time)
Phi.3=list(formula=~Sex+ageclass+time)
Phi.4=list(formula=~Sex+ageclass*Time)
Phi.5=list(formula=~Sex+ageclass+pup:Time)
Phi.6=list(formula=~Sex+ageclass*Time+brandaspup:nonpup)
Phi.7=list(formula=~Sex+ageclass*Time+brandaspup:nonpup+brandaspup:nonpup:digits)
Phi.8=list(formula=~Sex+ageclass+pup:Time+brandaspup:nonpup)
Phi.9=list(formula=~Sex+ageclass+pup:Time+brandaspup:nonpup+brandaspup:nonpup:digits)
Phi.10=list(formula=~Sex+ageclass+pup:Time+brandaspup:nonpup+brandasyr:twoplus)
Phi.11=list(formula=~Sex+ageclass+pup:Time+brandaspup:nonpup+brandaspup:nonpup:digits+brandasyr:twoplus)
Phi.12=list(formula=~Sex*ageclass+Time)
Phi.13=list(formula=~Sex*ageclass+time)
Phi.14=list(formula=~Sex*ageclass+ageclass:Time)
Phi.15=list(formula=~Sex*ageclass+pup:Time)
Phi.16=list(formula=~Sex*ageclass+ageclass:Time+brandaspup:nonpup)
Phi.17=list(formula=~Sex*ageclass+ageclass:Time+brandaspup:nonpup+brandaspup:nonpup:digits)
Phi.18=list(formula=~Sex*ageclass+pup:Time+brandaspup:nonpup)
Phi.19=list(formula=~Sex*ageclass+pup:Time+brandaspup:nonpup+brandaspup:nonpup:digits)
Phi.20=list(formula=~Sex*ageclass+pup:Time+brandaspup:nonpup+brandasyr:twoplus)
Phi.21=list(formula=~Sex*ageclass+pup:Time+brandaspup:nonpup+brandaspup:nonpup:digits+brandasyr:twoplus)
